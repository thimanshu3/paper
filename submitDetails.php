...
if (!$con) {
    ...
    $query2 = "INSERT into `submissions` (submission_id, researcher_id, title, no_of_pages, No_of_authors, submission_track, submission_assets) VALUES ('$subm_id', '$r_id', '$r_title', '$r_pages','$r_author_count','$r_track', '$target_file')";
